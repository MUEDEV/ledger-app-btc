...
APPNAME ="Komodo"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),monetaryunit)
# MonetaryUnit
DEFINES   += COIN_P2PKH_VERSION=16 COIN_P2SH_VERSION=76 COIN_FAMILY=2 COIN_COINID=\"MonetaryUnit\" COIN_COINID_HEADER=\"MUE\" COIN_COLOR_HDR=0xf89519 COIN_COLOR_DB=0x00d988 COIN_COINID_NAME=\"MonetaryUnit\" COIN_COINID_SHORT=\"MUE\" COIN_KIND=COIN_KIND_MUE COIN_FLAGS=FLAG_PEERCOIN_SUPPORT
APPNAME ="MonetaryUnit"
APP_LOAD_PARAMS += --path $(APP_PATH)
...
$(error Unsupported COIN - use bitcoin_testnet, bitcoin, bitcoin_cash, bitcoin_gold, litecoin, dogecoin, dash, zcash, horizen, komodo, monetaryunit, stratis, peercoin, posw, pivx, viacoin, vertcoin, stealth, digibyte, qtum, hcash, bitcoin_private, zcoin) 
endif
endif
